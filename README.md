...
1. **Download the Installer:**
   ...
   - Click on the latest Windows installer to download it. These are frequently updated. Look for a file with a name begiining/ending `Miniforge3-...-Windows-x86_64`. You may need to click on a triangle **Assets** toggle to see the latest releases (see screenshot).
